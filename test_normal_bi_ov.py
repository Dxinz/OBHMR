...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint', type=str, 
                        default='/home/user/桌面/code/HMR_INENET/DeepBHMR&GHMM(1)/DeepBHMR&GHMM/checkpoints/2024-02-03_16-30/models/best_transform_model.pth')# best_transform_model.pth  best_model.pth
