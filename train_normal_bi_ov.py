...
def _init_(args):
    ...
    os.system('cp train_normal_bi_ov.py checkpoints' + '/' + args.exp_name + '/' + 'train_normal_bi_ov.py.backup')
    os.system('cp bi_model_normal_Transformer_ov.py checkpoints' + '/' + args.exp_name + '/' + 'bi_model_normal_Transformer_ov.py.backup')
    os.system('cp data_pcd.py checkpoints' + '/' + args.exp_name + '/' + 'data_pcd.py.backup')
    os.system('cp modelov.py checkpoints' + '/' + args.exp_name + '/' + 'modelov.py.backup')
...
def train_one_epoch(epoch, model, loader, writer, log_freq, plot_freq):
    ...
    # for step, (pts1, pts2, pts1_normal, pts2_normal, T_gt, scale) in enumerate(loader):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--clean', type=bool, default=True)#False
    parser.add_argument('--partial', type=float, default=0.3)
    # model
